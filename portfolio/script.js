...
/* quote*/
// Array of quotes and hints
const quotes = [
  { text: "Cybersecurity is not just a skill, it’s a mindset.", hint: "Hint: Practice ethical hacking to stay ahead!" },
  { text: "A strong password is the first step in protecting your data.", hint: "Hint: Use multi-factor authentication always." },
  { text: "Network security is continuous, not occasional.", hint: "Hint: Monitor logs and traffic patterns regularly." },
  { text: "Hackers never sleep, neither should your vigilance.", hint: "Hint: Keep software updated." }
];

function updateQuote() {
  const randomIndex = Math.floor(Math.random() * quotes.length);
  document.getElementById('quote').textContent = quotes[randomIndex].text;
  document.getElementById('hint').textContent = quotes[randomIndex].hint;
}
...
setInterval(updateQuote, 1000); // new quote every 10 seconds
